...
const defaultAvatar = 'http://localhost:5000/images/defaultAvatar.png';

const Avatar: React.FC<AvatarProps> = ({size = 'md', user = undefined, imageUrl = defaultAvatar, ...rest}) => {

    const {turnOn: turnProfilePopUpOn} = useProfilePopUpState();
    const {turnOff: turnUserInfoPopUpOff} = useUserInfoPopUpState();
